...
.LC3:
	.string	"\033[32mx %d, y %x, z %d\n\033[0m"
.LC4:
	.string	"\033[33mH%x Wo%s\n\033[0m"
.LC5:
	.string	"\033[36mx=%d y=%d\n\033[0m"
	.text
	.align 4
...
.LM20:
	movl	%ebx, panicstr
	.stabn	68,0,81,.LM21-.LFBB3
.LM21:
/APP
/  81 "kern/init.c" 1
	cli; cld
/  0 "" 2
	.stabn	68,0,83,.LM22-.LFBB3
.LM22:
/NO_APP
	leal	20(%ebp), %esi
...
.LFBB4:
	...
	pushl	%ebx
	subl	$8, %esp
	.stabn	68,0,101,.LM28-.LFBB4
.LM28:
	leal	20(%ebp), %ebx
	.stabn	68,0,102,.LM29-.LFBB4
.LM29:
	pushl	12(%ebp)
	pushl	8(%ebp)
	pushl	$.LC8
	call	cprintf
	.stabn	68,0,103,.LM30-.LFBB4
.LM30:
	popl	%ecx
	popl	%eax
	pushl	%ebx
	pushl	16(%ebp)
	call	vcprintf
	.stabn	68,0,104,.LM31-.LFBB4
.LM31:
	movl	$.LC7, (%esp)
	call	cprintf
	.stabn	68,0,105,.LM32-.LFBB4
.LM32:
	addl	$16, %esp
	.stabn	68,0,106,.LM33-.LFBB4
.LM33:
	movl	-4(%ebp), %ebx
	leave
	ret
